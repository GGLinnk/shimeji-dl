...
class SpriteRejection(ValueError):
    ...
    def __init__(self, key: str, raw_value: bytes, message: str) -> None:
...
class InvalidSpritePath(SpriteRejection):
    ...
    def __init__(self, key: str, raw_value: bytes) -> None:
        super().__init__(key, raw_value, f"sprite key is not a valid asset path: {key!r}")
...
class SpriteAbsoluteUrlPresent(SpriteRejection):
    ...
    def __init__(self, key: str, raw_value: bytes) -> None:
        super().__init__(key, raw_value, f"sprite key normalized to an absolute URL: {key!r}")
...
class SpriteWrongSuffix(SpriteRejection):
    ...
    def __init__(self, key: str, raw_value: bytes) -> None:
        super().__init__(key, raw_value, f"sprite key is not a PNG asset: {key!r}")
...
class InvalidSpriteRegion(SpriteRejection):
    ...
    def __init__(self, key: str, raw_value: bytes) -> None:
        super().__init__(key, raw_value, f"sprite region failed validation: {key!r}")
